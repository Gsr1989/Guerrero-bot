...
app = FastAPI(lifespan=lifespan, title="Sistema Guerrero Digital", version="5.0")
...
async def status_detail():
    return {
        "sistema": "Guerrero Digital v5.0 - /chuleta selectivo",
        "entidad": "Guerrero",
        "vigencia_dias": 30,
...
if __name__ == '__main__':
    try:
        ...
        print(f"[SISTEMA] Guerrero v5.0 - Botones Inline + /chuleta selectivo")
